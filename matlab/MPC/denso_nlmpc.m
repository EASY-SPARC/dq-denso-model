...
%     t = 1:nlobj.PredictionHorizon+1;
%     
%     subplot(4, 2, 1);
%     plot(t, info.Xopt(:, 1));
%     hold on
%     plot(t, setpoint(1, 1:21));
%     xlabel("t(s)");
